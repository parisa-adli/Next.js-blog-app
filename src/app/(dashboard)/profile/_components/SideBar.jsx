    ...
    <div className="overflow-y-auto flex flex-col p-5 h-screen pt-10 lg:pt-8">
      ...
      <div className="overflow-y-auto flex-auto">
        ...
        <div
          ...
          className="flex items-center gap-x-1 rounded-2xl font-medium transition-all duration-200 text-secondary-700 py-3 px-4 hover:text-red-400 cursor-pointer"
        >
